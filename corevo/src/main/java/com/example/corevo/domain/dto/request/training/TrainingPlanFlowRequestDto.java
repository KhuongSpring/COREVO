...
public class TrainingPlanFlowRequestDto {
  ...
  @Schema(description = "Danh sách giá trị người dùng chọn ở bước hiện tại (thường 1 phần tử, nhưng có thể nhiều ở bước như equipment/location)", example = "[\"Gain weight\"]")
  ...
  @Schema(description = "Lưu trữ toàn bộ các bước và giá trị mà người dùng đã chọn trước đó", example = """
          {
            "goals": ["Gain weight"],
            "level": ["BEGINNER"],
            "duration": ["30 phút"],

...
@Mapper(componentModel = "spring", uses = TrainingExerciseGroupDetailMapper.class, nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE, nullValueCheckStrategy = NullValueCheckStrategy.ALWAYS)
public interface TrainingExerciseGroupMapper {
    ...
    @Mapping(target = "exercises", source = "exercises")
    TrainingExerciseGroupResponseDto trainingExerciseGroupToTrainingExerciseGroupResponseDto(
            TrainingExerciseGroup entity);
}

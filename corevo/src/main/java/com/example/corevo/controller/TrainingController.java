...
public class TrainingController {
        ...
        public ResponseEntity<?> getExerciseByPrimaryMuscle(
                ...
                return VsResponseUtil
                                .success(trainingService.getPreviewExerciseByPrimaryMuscle(primaryMuscle, request));
        }
        ...
        public ResponseEntity<?> getTrainingSchedule(@RequestParam(name = "planId") Long planId) {
